...
y1=y;
x1=x;
x(x > 0.8e-7 & x < 1e-7 & y > 0.6e-7) = x(x > 0.8e-7 & x < 1e-7 & y > 0.6e-7) - 0.4e-7;
x(x > 1e-7 & x < 1.2e-7 & y > 0.6e-7) = x(x > 1e-7 & x < 1.2e-7 & y > 0.6e-7)  + 0.4e-7;
x(x > 0.8e-7 & x < 1e-7 & y < 0.4e-7) = x(x > 0.8e-7 & x < 1e-7 & y < 0.4e-7) - 0.4e-7;
x(x > 1e-7 & x < 1.2e-7 & y < 0.4e-7) = x(x > 1e-7 & x < 1.2e-7 & y < 0.4e-7)  + 0.4e-7;
...
for t=1:1:step
    ...
    RVx(x1 < 0.8e-7 & x >= 0.8e-7 & (y >= 0.6e-7 | y < 0.4e-7)) = - RVx(x1 < 0.8e-7 & x >= 0.8e-7 & (y >= 0.6e-7 | y < 0.4e-7));
    x(x1 < 0.8e-7 & x >= 0.8e-7 & (y >= 0.6e-7 | y < 0.4e-7)) = 0.8e-7 - (x(x1 < 0.8e-7 & x >= 0.8e-7 & (y >= 0.6e-7 | y < 0.4e-7)) - 0.8e-7);
    RVx(x1 > 1.2e-7 & x <= 1.2e-7 & (y >= 0.6e-7 | y < 0.4e-7)) = - RVx(x1 > 1.2e-7 & x <= 1.2e-7 & (y >= 0.6e-7 | y < 0.4e-7));
    x(x1 > 1.2e-7 & x <= 1.2e-7 & (y >= 0.6e-7 | y < 0.4e-7)) = 1.2e-7 + (1.2e-7 -  x(x1 > 1.2e-7 & x <= 1.2e-7 & (y >= 0.6e-7 | y < 0.4e-7)));
    RVy(y1 < 0.6e-7 & y >= 0.6e-7 & x >= 0.8e-7 & x <= 1.2e-7) = -RV(y1 < 0.6e-7 & y >= 0.6e-7 & x >= 0.8e-7 & x <= 1.2e-7);
    y(y1 < 0.6e-7 & y >= 0.6e-7 & x >= 0.8e-7 & x <= 1.2e-7) = 0.6e-7 - (y(y1 < 0.6e-7 & y >= 0.6e-7 & x >= 0.8e-7 & x <= 1.2e-7) - 0.6e-7);
    RVy(y1 > 0.4e-7 & y <= 0.4e-7 & x >= 0.8e-7 & x <= 1.2e-7) = -RVy(y1 > 0.4e-7 & y <= 0.4e-7 & x >= 0.8e-7 & x <= 1.2e-7);
    y(y1 > 0.4e-7 & y <= 0.4e-7 & x >= 0.8e-7 & x <= 1.2e-7) = 0.4e-7 + (0.4e-7 - y(y1 > 0.4e-7 & y <= 0.4e-7 & x >= 0.8e-7 & x <= 1.2e-7));
